...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Linker.end_date'
        db.add_column('articles_linker', 'end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Linker.end_date'
        db.delete_column('articles_linker', 'end_date')
