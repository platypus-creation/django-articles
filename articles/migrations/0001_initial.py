...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('articles_article', (
            ('picture', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'articles', to=orm['auth.User'])),
        ...
        db.create_table('articles_scheduler', (
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'schedulers', to=orm['articles.Article'])),
            ('url_pattern', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('articles', ['Scheduler'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('articles_scheduler')
    ...
    models = {
        ...
        'articles.scheduler': {
            ...
            'article': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'schedulers'", 'to': "orm['articles.Article']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
